...
public class House {
    ...
    public String toString() {
        return "designpatterns.BuilderDesingPattern.House [foundation=" + foundation + ", structure=" + structure +
    ...
    public static class HouseBuilder {
        ...
        // Build method to create the final designpatterns.BuilderDesingPattern.House object
        public House build() {
